...
client = commands.Bot(command_prefix = "t.")#sets the bot command prefix to t.

client.remove_command('help')# removes the default discord.py help command to replace with custom help command

extensions = [ 'cogs.bitcoin',  'cogs.catgirl', 'cogs.char_search2', 'cogs.CMath', 'cogs.eightballt', 'cogs.ETime', 'cogs.help', 'cogs.history', 'cogs.Ping', 'cogs.players', 'cogs.plex2', 'cogs.poll', 'cogs.price', 'cogs.range', 'cogs.route', 'cogs.turtle', 'cogs.weather']
