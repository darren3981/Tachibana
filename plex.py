...
class PLEX:
    ...
    async def plex(self):
        data = json.load(urllib.request.urlopen('https://esi.evetech.net/latest/markets/10000002/orders/?datasource=tranquility&order_type=sell&page=1&type_id=44992'))
        output_list = [x['price'] for x in data]
